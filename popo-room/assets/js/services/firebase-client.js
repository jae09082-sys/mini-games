...
export let ready;
export function retryAuthentication(){ready=setPersistence(auth,browserSessionPersistence).then(()=>signInAnonymously(auth)).then(r=>r.user.uid);ready.catch(()=>{});return ready}
retryAuthentication();
